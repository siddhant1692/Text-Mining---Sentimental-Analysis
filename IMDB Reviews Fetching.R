...
txt <- iconv(IMDB_reviews, "UTF-8") #Unicode Transformation Format. The '8' means it uses 8-bit blocks to represent a character
...
plot(
  ft_values, 
  type ="l", 
  main ="IMDB Endgame reviews using Transformed Values", 
  xlab = "Narrative Time", 
  ylab = "Emotional Valence", 
  col = "red"
)
